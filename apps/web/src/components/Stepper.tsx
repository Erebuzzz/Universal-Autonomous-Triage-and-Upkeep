import React, { useState, Children, useRef, useLayoutEffect, type ReactNode, type HTMLAttributes } from "react";
...
function StepContentWrapper({
  ...
  const [parentHeight, setParentHeight] = useState<number | "auto">(0);
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#1e293b", color: "#94a3b8" },
          active: { scale: 1.1, backgroundColor: "#10b981", color: "#ffffff" },
